            ...
            if (chat.welcome) {
                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        text = (action === 'add' ? (chat.sWelcome || this.welcome || Connection.conn.welcome || 'Valor Bot is a suite of open source software for WhatsApp Application based on Baileys WebSocket API.\n\n_Some highlight features:_\n• Downloader (youtube, fb, insta, etc.)\n• Sticker Creator\n• Tag All\n• Games\n• Internet Search (google text & image search)\n• AFK\n• Broadcast\n\n*Valor Bot Source*\nhttps://bit.ly/Valor_Bot\n\n*Valor Bot Test Group*\nhttps://bit.ly/Valor_Bot_Test\n\n*Valor Bot Bug Report*\nhttps://bit.ly/Valor_Bot_Bug_Report\n\n*Valor Bot Feature Request*\nhttps://bit.ly/Valor_Bot_Feature_Request').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || 'ɴᴏ ɢʀᴏᴜᴩ ᴅᴇsᴄʀɪᴩᴛɪᴏɴ') :
