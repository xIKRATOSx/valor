...
[`ᴏᴋ 👌`, `${usedPrefix}ok`]
  ...
  switch (type) {
    ...
    case 'statusonly':
      ...
      break
    default:
      if (!/[01]/.test(command)) return conn.sendHydrated(m.chat, header, footer.trim(), buffer, null, null, null, null, button, m, {asLocation:true})
      throw false
  }
  m.reply(`
